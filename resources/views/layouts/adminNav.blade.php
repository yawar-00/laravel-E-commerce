...
<nav x-data="{ open: false }" class="bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-600 dark:from-gray-900 dark:to-gray-800 text-white shadow-lg" style="background-color:#bfc7a4">
